...
echo('Data: ' . $fname . 'phone:'. $lname . $email . $reason . $comments . '</br>');
...
if ($fname == null || $lname == null || $reason == null ||
	...
	(first_name, last_name, email_address, visit_reason, 
            visit_msg, visit_date, employee_id)
    ...
    //echo('Data: ' . $fname . $lname . $email . $reason . $comments);
}
?>
<!DOCTYPE html>
<html lang="">
    ...
    <body>
        ...
        <div class="customM1 container">
            <section class="container rounded mt-5 p-5">
                <h1>Message Sent</h1>
                <h3>Thank you, <?php echo $fname; ?>, for your message!</h3>
